...
export default function Home() {
            ...
            <div className={styles.cardContainer} key={driver.id}>
                <Link to={`/detail/${driver.id}`}>
                    <Card
                        ...
                        image={driver.image ? driver.image : <img src="https://id.imgur.com/MYTNMWl.png" />}
    ...
    return (
        <div className={styles.divPadre}>
            ...
            <div className={styles.divFragment}>
            ...
            <div className={styles.divSelects}>
                ...
                <div>
                    ...
                    <select onChange={event => handleFilterName(event)}>
                        ...
                        <option value="asc">A - Z</option>         //Orden Ascendente/Descendente
                        <option value="desc">Z - A</option>
                    </select>

                    <select onChange={event => handleFilterDob(event)}>
                        <option value="ascDob">Mas jovenes primero</option>         //Orden Ascendente/Descendente Dob
